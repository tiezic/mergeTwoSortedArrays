import static org.junit.jupiter.api.Assertions.assertArrayEquals;  //import junit libraries
...
public class mergeTest {
    ...
    public void testCopy(int[] arr1, int[] arr2, int[] expectArr) {
        ...
        assertArrayEquals(expectArr, obj.mergeArrays(arr1, arr2));  //if the merged array == the expected array then pass test

    }

    static Stream<Arguments> arrayList() {                          //list of array test cases
        return Stream.of(
            Arguments.of(
